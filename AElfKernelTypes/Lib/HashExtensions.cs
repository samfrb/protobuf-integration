...
namespace AElf.Kernel.Extensions
{
    public static class HashExtensions
    {
        ...
        public static byte[] CalculateHash(this object obj)
        {
            ...
            //return CalculateHash(Encoding.UTF8.GetBytes(JsonConvert.SerializeObject(obj)));
            return CalculateHash(Encoding.UTF8.GetBytes("fake"));
        }
        ...
        public static byte[] CalculateHashWith(this object obj, object another)
        {
            ...
            //return CalculateHash(Encoding.UTF8.GetBytes(JsonConvert.SerializeObject(obj) + JsonConvert.SerializeObject(another)));
            return CalculateHash(Encoding.UTF8.GetBytes("fake"));
        }
